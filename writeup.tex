...
\noindent {\bf(6)}  \\
\noindent {\bf(a)} As we increase K we allow topics to become more and more specific meaning that we can label individual documents with a might higher granularity increasing the log likelihood. This greatly increases our likelihood on test data to a point (around K=40) afterwards we start overfitting the training data and our rate begins to drop off again. \\
\\
